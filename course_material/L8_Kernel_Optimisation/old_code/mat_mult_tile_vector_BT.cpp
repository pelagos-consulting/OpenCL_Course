...
int main(int argc, char** argv) {
    ...
    H_ERRCHK(clSetKernelArg(kernel_mat_mult, 3, sizeof(cl_uint), &N1_A_star_v ));
    ...
    H_ERRCHK(clSetKernelArg(kernel_mat_mult, 6, sizeof(cl_uint), &chunk_len_v ));
